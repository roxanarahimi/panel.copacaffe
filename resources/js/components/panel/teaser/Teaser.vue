<template>
    <transition name = "route" mode = "out-in" appear>
        <section class = "" v-if = "data.id">
            ...
            <router-link :to = "'/panel/edit/teaser/'+data.id" class = "text-dark">
                <span title = "ویرایش تیزر" class = "mx-3 p-2 d-inline-block align-middle bg-dark text-light rounded-circle">
        ...
        <div v-else><p class = "fw-bold">این تیزر موجود نیست</p></div>
